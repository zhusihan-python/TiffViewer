...
from myimages.rest.datas import DataDetailMixin, DataMixin
from myimages.rest.metadata import MetaDataDetailMixin, MetaDataMixin
from myimages.rest.tiles import TilesDetailMixin, TilesMixin
